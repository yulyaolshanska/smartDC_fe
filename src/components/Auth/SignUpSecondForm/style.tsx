...
import { StylesConstantsColor } from '@components/Auth/SignUpSecondForm/constants/styles';
import { SignInButtonProps } from '@components/Auth/SignUpSecondForm/types';
